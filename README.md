...
To create interactive web applications using HTML, CSS, and JavaScript
To implement event handling for keyboard and mouse actions
To organize multiple tasks under a single experiment using navigation.                                                                                                           
...
For 2.3 Scribble Board, the HTML canvas element is used. Mouse events are handled using JavaScript to allow freehand drawing with the mouse in blue color.
